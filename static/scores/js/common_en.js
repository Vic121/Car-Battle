function activity_point_switch(pts) {
    ...
    for (var i = 0; i < times; i++) {
        html += "<img src='http://static.pickscore.net/images/dot_" + colour + ".png' style='position: relative; top: 1px;' />";
    }
...
$(document).ready(function () {
    ...
    /*
     ...
     hover_box.click(function() { hover_box.remove(); });
     }
     });
     });
     },
