...
urlpatterns = patterns('',
                       url(r'^login/$', 'main.views.index.register', name='auth_login'),
                       url(r'^logout/$', 'main.views.index.logout', name='auth_logout'),
                       # Activation keys get matched by \w+ instead of the more specific
                       # [a-fA-F0-9]{40} because a bad activation key should still get to the view;
                       # that way it can return a sensible "invalid key" message instead of a
                       # confusing 404.
                       # url(r'^activate/(?P<activation_key>\w+)/$', activate, name='registration_activate'),
                       # url(r'^login/$', register, {'template_name': 'registration/login.html'}, name='auth_login'),
                       ...
                       #
                       # url(r'^register/$', register, {'form_class': RegistrationFormUniqueEmail}, name='registration_register'),
